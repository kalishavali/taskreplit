...
import { updateTeamSchema, type Team } from "@shared/schema";
import { Users } from "lucide-react";

const formSchema = updateTeamSchema.extend({
...
export function TeamEditModal({ team, open, onOpenChange }: TeamEditModalProps) {
  ...
  const updateTeamMutation = useMutation({
    mutationFn: (data: FormData) => apiRequest(`/api/teams/${team.id}`, "PATCH", data),
    onSuccess: () => {
